(function() {
  ...
  $recording = $('#recording_0');$timeDisplay = $('#time-display_0');$record = $('#record_0');$cancel = $('#cancel_0');$recordingList = $('#recording-list_0');
  ...
  $record.on('click', function() {
    if (audioRecorder.isRecording()) {
      stopRecording(true,$record.selector.slice(-1));
    } else {
      startRecording($record.selector.slice(-1));
    }
  });

  $cancel.on('click', function() {
    stopRecording(false,$cancel.selector.slice(-1));
  });
